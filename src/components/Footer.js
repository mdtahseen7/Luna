        ...
        <div>
            <footer className="bg-[#151518] mt-10">
                    ...
                    <div className="lg:flex lg:justify-between">
                        <div class="mb-6 lg:mb-0">
                            <Link class="flex items-center w-fit" href="/">
                                <p class="Akira self-center !text-4xl tracking-wider font-medium whitespace-nowrap dark:text-white">Akira</p>
                                </Link>
                ...
                <div className="mx-auto w-full lg:max-w-[83%] lg:flex lg:items-center lg:justify-between lg:text-[0.8rem] text-[0.7rem] text-[#ffffffb2] py-3">
                    <span className="sm:text-center ms-5 lg:ms-0">© {year} <Link href="/" className="hover:text-white">Akira™</Link>
                     {/* | Made by <span className="font-bold" ></span> */}
                    </span>
                    <div className="flex mt-4 lg:justify-center lg:mt-0">
                        <Link href="https://github.com/mdtahseen7/airin-revived" target="_blank" className=" hover:text-gray-900 dark:hover:text-white ms-5 lg:ms-0">
                        ...
                        <Link href="https://www.instagram.com/md_tahseen_7" target="_blank" className=" hover:text-gray-900 dark:hover:text-white ms-5">
